    ...
    <div class="collapse navbar-collapse justify-content-end" id="menu">
        ...
        <ul class="navbar-nav">
            ...
            <form class="form-group p-3" align="center" action="controleur_modif.php" method="post">
                ...
                <label class="form-label" for="Id_personne_exposees">Num</label>
                <input class="form-control" type='text' name="Id_personne_exposees" id="Id_personne_exposees" value="<?=$personne['Id_personne_exposees']?>"  readonly="readonly">
                <label class="form-label" for="tous_les_personnels_EN">tous les personnels EN</label>
                <input class="form-control" type="text" name="tous_les_personnels_EN" id="tous_les_personnels_EN" value="<?=$personne['tous_les_personnels_EN']?>">
                <label class="form-label" for="tous_les_ATTEE">tous les ATTEE</label>
                <input class="form-control" type="text" name="tous_les_ATTEE" id="tous_les_ATTEE" value="<?=$personne['tous_les_ATTEE']?>">
                <label class="form-label" for="tous_les_eleves">tous les eleves</label>
                <input class="form-control mb-3" type="text" name="tous_les_eleves" id="tous_les_eleves" value="<?=$personne['tous_les_eleves']?>">	
