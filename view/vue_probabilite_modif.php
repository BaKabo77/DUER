    ...
    <div class="collapse navbar-collapse justify-content-end" id="menu">
        ...
        <ul class="navbar-nav">
            ...
            <form class="form-group p-3" align="center" action="controleur_modif.php" method="post">
                ...
                <label class="form-label" for="Id_Probabilite">Num</label>
                <input class="form-control" type='text' name="Id_Probabilite" id="Id_Probabilite" value="<?=$probabilite['Id_Probabilite']?>"  readonly="readonly">
                <label class="form-label" for="probabilite">Probabilite</label>
                <input class="form-control mb-3" type="text" name="probabilite" id="probabilite" value="<?=$probabilite['probabilite']?>">	
