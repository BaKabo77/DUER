...
<div class="container">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="menu">
        ...
        <ul class="navbar-nav">
            ...
            <form class="table-responsive form-group m-1" action="../controller/controleur_supp.php" method="POST">            <input type="hidden" name="mode" value="3">
                    ...
                    <?php
                        ...
                        if($nb > 0) 
                        {
                            ...
                            while ($i<$nb)
                            {
                                ...
                                echo "<td>$num</td>";
                                echo "<td>$prob</td>";
                                echo "<td><a href='/DUER/probabilite/$num'><input class='btn btn-primary' type='button' value='Modifier'></a></td>";
                                echo "</tr>";
                                $i=$i+1;
                            }
                        }	
