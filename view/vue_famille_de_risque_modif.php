...
<div class="container">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="menu">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="bg-dark nav-link nav-link text-light" href="vue_admin.php">Accueil</a>
            </li>
            ...
            <form class="form-group container" align="center" action="/DUER/menu/modification" method="post">
                <input type="hidden" name="mode" value="6">    

                <label class="form-label" for="Id_Famille_de_risque">Num</label>
                <input class="form-control" type='text' name="Id_Famille_de_risque" id="Id_Famille_de_risque" value="<?=$famille['Id_Famille_de_risque']?>"  readonly="readonly">
                <label class="form-label" for="famille">Famille</label>
                <input class="form-control" type="text" name="famille" id="famille" value="<?=$famille['famille']?>">	
                
                <input class="btn btn-success mt-3" type="submit" value="Modifier" name="submit">
            </form>
            <?php }else{ ?>
                ...
                <label class="form-label" for="Id_Famille_de_risque">Num</label>
                <input class="form-control" type='text' name="Id_Famille_de_risque" id="Id_Famille_de_risque" value="<?=random_int(1,999)?>" readonly="readonly">
                <label class="form-label" for="famille">Famille</label>
                <input class="form-control mb-3" type="text" name="famille" id="famille" >	
