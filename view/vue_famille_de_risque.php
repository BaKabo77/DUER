...
<div class="container">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="menu">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="bg-dark nav-link text-light" href="/DUER/admin">Acceuil</a>
            </li>
            ...
            <table class="table-bordered table container table-striped" width="60%" align="center">
                    ...
                    <?php
                            ...
                            if($nb > 0) 
                            {
                                ...
                                while ($i<$nb)
                                {
                                    ...
                                    echo "<td>$num</td>";
                                    echo "<td>$famille</td>";
                                    echo "<td><a href='/DUER/famille-de-risque/$num'><input class='btn btn-primary' type='button' value='Modifier'></a></td>";
                                    echo "</tr>";
                                    $i=$i+1;
                                }
                            }	
                    ...
                    <tr>
                        <td align="center" colspan="4" >
                            <input class="btn btn-success" type="button" onclick="location.href='/DUER/famille-de-risque/ajouter'" value="Ajouter" />
